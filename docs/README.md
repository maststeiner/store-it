...
1. **Process layer** — [`process/`](process/): the KAIFe L4 development process,
...
| Path | Layer | Content |
|------|-------|---------|
| [`process/`](process/) | Process | KAIFe L4: process, project interface, Definition of Done, changelog, personas, templates |
...
| [`metrics.md`](metrics.md) | Project | Pilot metrics: flow + quality data points and trend (KAIFe §8) |
