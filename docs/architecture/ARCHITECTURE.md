...
| Production | Kubernetes | TODO: cluster/provider, ingress, DB hosting — decision drafted in [ADR-005](ADR-005-hosting-deployment.md) (Proposed); this row is updated on acceptance (SPEC-005 AC-23) |
...
| [ADR-005](ADR-005-hosting-deployment.md) | Hosting and deployment — one free Oracle Cloud VM, Docker Compose, pull-based updates | Proposed | 2026-09-17 |
